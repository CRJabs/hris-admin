...
function TrainingList({ title, data, icon: Icon, isEditing, columns, onUpdate }) {
  return (
    <Card className="shadow-none border-muted">
      <CardHeader className="p-4 pb-2 flex flex-row items-center justify-between space-y-0 bg-[#0C005F]/5">
        <CardTitle className="text-sm font-bold flex items-center gap-2">
...
export default function TrainingDevTab({ employee, isReadOnly = false, isEditing = false, onUpdate }) {
  const trainCols = [
